...
・Carテーブル
    論理名，物理名，データ型，制約
    車種ID, id, Integer, Primary Key
    車種名, car_name, String(30), Not Null

・Reservationテーブル
    論理名，物理名，データ型，制約
    予約ID, id, Integer, Primary Key
    車種ID, car_id, Integer, Foreign Key(Car.id), Not Null
    予約日, reservation_date, Date, Not Null
    予約時間帯, reservation_time, String(20), Not Null
    姓, last_name, String(32), Not Null
    名, first_name, String(32), Not Null
    電話番号, phone_number, String(11), Not Null
    メールアドレス, email, String(80), Not Null
...
デプロイはしない．
試乗車種の追加・削除・故障は発生しない．
データ削除は，論理削除ではなく，物理削除で行う．
車種の選択肢は，CX-60とCX-80とする．
予約時間帯は，10:00~12:00, 13:00~15:00, 16:00~18:00とする．
